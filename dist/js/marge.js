...
/* WEBPACK VAR INJECTION */(function($) {function Tab1($node) {
	this.$node = $node
	this.init();
	this.bindIn();
	this.bindOut();
...
/* WEBPACK VAR INJECTION */(function($) {var Tab1 = __webpack_require__(0);
new Tab1($(".fs_col1"))
var Tab2 = __webpack_require__(3);
...
/* WEBPACK VAR INJECTION */(function($) {function Tab3($node){
	this.$node = $node;
	this.init();
	this.bind();
	this.bindShow();
...
/* WEBPACK VAR INJECTION */(function($) {function Carousel($node){
	this.$node = $node;
	this.init();
	this.bind();
	this.auto();
